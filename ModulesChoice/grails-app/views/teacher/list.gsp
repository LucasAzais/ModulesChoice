			...
			<table>
				<thead>
					<tr>
						...
						<g:sortableColumn property="surname" title="${message(code: 'teacher.surname.label', default: 'Surname')}" />
				...
				<g:each in="${teacherInstanceList}" status="i" var="teacherInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
						...
						<td><g:link action="show" id="${teacherInstance.id}">${fieldValue(bean: teacherInstance, field: "surname")}</g:link></td>
