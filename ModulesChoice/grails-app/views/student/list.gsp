			...
			<table>
				<thead>
					<tr>
						...
						<g:sortableColumn property="surname" title="${message(code: 'student.surname.label', default: 'Surname')}" />
				...
				<g:each in="${studentInstanceList}" status="i" var="studentInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
						...
						<td><g:link action="show" id="${studentInstance.id}">${fieldValue(bean: studentInstance, field: "surname")}</g:link></td>
